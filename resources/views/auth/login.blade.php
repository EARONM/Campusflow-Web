    ...
    <form method="POST" action="{{ route('login') }}" class="w-full max-w-6xl px-4">
        ...
        <div class="overflow-hidden bg-white shadow-2xl rounded-3xl grid grid-cols-1 lg:grid-cols-2 min-h-[680px]">
            ...
            <div class="relative hidden lg:flex items-center justify-center p-10">
                ...
                <div class="absolute inset-0 bg-green-900/75 backdrop-blur-sm"></div>
            ...
            <!-- Right Login Side -->
            <div class="flex items-center justify-center px-8 py-12 sm:px-12">
                ...
                <div class="w-full max-w-md">
                    ...
                    <div class="mb-5">
                        ...
                        <input
                            ...
                            class="w-full h-12 rounded-xl border border-gray-300 px-4 text-gray-800 focus:border-green-600 focus:ring-2 focus:ring-green-200"
                        >
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    class="w-full h-12 rounded-xl border border-gray-300 px-4 pr-12 text-gray-800 focus:border-green-600 focus:ring-2 focus:ring-green-200"
                                >

                                <button
                                    type="button"
                                    onclick="togglePassword()"
                                    class="absolute inset-y-0 right-0 px-4 text-gray-500 hover:text-green-700"
                                >
